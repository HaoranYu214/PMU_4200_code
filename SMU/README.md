...
lives in the repository-level shared library at `../src/smu/`.
...
Runtime PMU and SMU connections use the shared `../src/transport.py`. The
vendor `instrcomms.py` in `reference/official_examples/System Mode/` is kept
...
Manual locations in `reference/manual/4200A-KXCI-907-01D_May_2024.pdf`:
