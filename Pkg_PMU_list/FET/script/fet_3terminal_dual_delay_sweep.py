...
Each delay invokes fet_3terminal_dual_segarb.main() as a fresh PMU session.
The dual test remains responsible for the exact positive/negative write and
read parameters; configure those in fet_3terminal_dual_segarb.py.
"""
...
# Store all individual runs and the combined summary in one dated directory.
...
def save_summary(summary, output_dir):
    workbook_path = output_dir / "FeFET_dual_delay_summary.xlsx"
    ...
    fig.tight_layout()
    plot_path = output_dir / "FeFET_dual_delay_summary.png"
