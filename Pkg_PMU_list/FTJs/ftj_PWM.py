...
ch1_full_pwm_config, ch2_full_pwm_config, PWM_STEPS = make_pwm_sequence(FULL_PWM_SEQ_ID)
...
SEQ_LIST = {
    CH1: [(FULL_PWM_SEQ_ID, 1)],
    CH2: [(FULL_PWM_SEQ_ID, 1)],
}
...
def preview_waveform(output_path=None):
    ...
    preview_config = (0,) + ch1_full_pwm_config[1:]
