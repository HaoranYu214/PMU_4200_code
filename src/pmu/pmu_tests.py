...
#
# Each 4225-PMU channel can store at most 2048 Segment ARB segments. One
# sequence may use all 2048, but multiple sequences on the same channel share
# that total. CH1 and CH2 each have their own 2048-segment allowance; waveform
# loop counts do not consume additional stored segments.
