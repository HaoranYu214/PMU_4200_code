...
def build_plot_data(
    ...
    *,
    ...
    only commanded/measured numeric values plus absolute current columns.
    """
    requested = [
    ...
    plot_data.insert(3, "AbsI1", plot_data["I1"].abs())
    plot_data.insert(6, "AbsI2", plot_data["I2"].abs())
    return plot_data
