...
params = {
    # Voltage held before/after every pulse. Keep this independent from the
...
def _sync_parameter_aliases():
    ...
    global PREPOST_DWELL, WRITE_DWELL, READ_DWELL
...
def _rebuild_runtime_config():
    ...
    meas_start_read = [0.0, READ_DWELL * 0.5, 0.0, 0.0]
    meas_stop_read = [0.0, READ_DWELL * 0.9, 0.0, 0.0]
    SCAN_LEVELS = voltage_sweep_path(VP, WRITE_LEVEL_STEP)
...
def preview_waveform(output_path=None, *, show=True, title_prefix="FTJ RV1 CH1"):
